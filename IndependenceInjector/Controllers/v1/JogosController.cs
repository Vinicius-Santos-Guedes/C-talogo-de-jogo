using IndependenceInjector.Exceptions;
using IndependenceInjector.InputModel;
using IndependenceInjector.Services;
using IndependenceInjector.ViewModel;
...
namespace IndependenceInjector.Controllers.v1
{
    ...
    public class JogosController : ControllerBase
    {
        ...
        [HttpPut("{idJogo:guid}")]
        public async Task<ActionResult<JogoViewModel>> AlterarJogo(Guid idJogo, JogoInputModel jogoInputModel)
        {
            try
            {
        ...
        public async Task<ActionResult<JogoViewModel>> ExcluirJogo(Guid idJogo)
        {
            try
            {
